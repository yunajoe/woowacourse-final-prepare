...
export const askPromotionItemNotApplicable = async (productName, freeCount) => {
  return await readUserInput(`현재 ${productName}은(는) ${freeCount}개가 프로모션 할인이 적용되지 않습니다. 그래도 구매하시겠습니까? (Y/N)))\n`);
};
